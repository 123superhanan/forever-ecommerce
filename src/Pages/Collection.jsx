...
const Collection = () => {
  ...
  // // Set initial product list when the component mounts
  // useEffect(() => {
  //   setFilterProduct(products);
  // }, [products]);

  // // Log the selected categories and subcategories whenever they change
  // useEffect(() => {
  ...
  // slicing the products and creating product copy to store product so whenever user selects any filter it will display those specific product product
  const applyFilter = () => {
